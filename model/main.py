...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/root/autodl-tmp/Test/ships_gammatone_dataset_split10', type=str,
                        help='dataset path')
    parser.add_argument('--eval_data_path', default='/root/autodl-tmp/Test/ships_gammatone_dataset_split10/val', type=str,
