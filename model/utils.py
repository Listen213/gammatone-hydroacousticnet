...
# from torch._six import inf  # 旧版本PyTorch的导入方式
from math import inf  # 新版本PyTorch使用math.inf

# from tensorboardX import SummaryWriter  # 旧方式
from torch.utils.tensorboard import SummaryWriter  # 使用PyTorch内置的TensorBoard
